...
- Manual decision-threshold tuning (0.5 → 0.35 → 0.25) instead of accepting the default 50% cutoff
...
| Logistic Regression (0.35 threshold) | 86.3% | 83.0% | 56.0% | 66.9% | — |
